    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">Tanmay</span>
 ...
 <div class="panel panel-default">
    ...
    %>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <thead>
          <tr>
            <th data-breakpoints="xs">JID</th>
            <th>Job Title</Title></th>
            <th>Job Description</th>
            <th>Job Salaryrange</th>
            <th data-breakpoints="xs">Job Qualities</th>
           
            <th data-breakpoints="xs">Job Experience</th>
       ...
       <% while(rs.next()){ %>
        <tbody>
          <tr data-expanded="true">
            ...
            <td><a href="hrdelete.jsp?jid=<%=rs.getInt(1)%>">Delete</a></td>
            <td><a href="hortlist.jsp?jid=<%=rs.getInt(1)%>">View</a></td>
          </tr>    
        </tbody>
        	<%}%>
      </table>
